...
## 2. Inputs
- input_candidates: `dataset/setting_a/24_noinj_ontology/test_top20_type_filtered_raw.json`
- input_evidence: `dataset/setting_a/24b_noinj_evidence/test_aligned_evidence.json`
...
## 3. Output
- ontology_candidate_artifact: `dataset/setting_a/24_noinj_ontology/test_top20_ontology_raw.json`
- ontology_filter_report: `dataset/setting_a/24_noinj_ontology/ontology_filter_report_test.json`
