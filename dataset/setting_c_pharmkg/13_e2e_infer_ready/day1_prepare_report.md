...
- Path: `dataset/setting_c_pharmkg/13_e2e_infer_ready/entity_embeddings_rgcn.pt`
- Shape: `[7247, 128]`
...
- Output dir: `dataset/setting_c_pharmkg/13_e2e_infer_ready/backbone_raw`
- train: 28960 rows
...
- Output dir: `dataset/setting_c_pharmkg/13_e2e_infer_ready/soft_support_raw`
- train: 28960 rows
- valid: rows=500, Gold@20=0.07, Rank21=465, avg_subgraph_size=100, max_rel_id=27
- test: rows=500, Gold@20=0.092, Rank21=454, avg_subgraph_size=100, max_rel_id=27
...
- Output dir: `dataset/setting_c_pharmkg/13_e2e_infer_ready/fuzzy_retrieval_main`
- train: 28960 rows
...
```bash
--kge_embedding_path dataset/setting_c_pharmkg/13_e2e_infer_ready/entity_embeddings_rgcn.pt \
--graph_num_rels 28
```
