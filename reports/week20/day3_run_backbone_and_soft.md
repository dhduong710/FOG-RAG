# Day 3 — E2E infer for backbone_raw and soft_support_raw
...
## 1. backbone_raw — candidate ceiling reviewer-safe
- num_examples: `500`
- k: `20`
...
## 2. backbone_raw — E2E generation reviewer-safe
- num_examples: `500`
- k: `20`
- gold_present_rate: `0.24`
- mrr_at20: `0.04763573`
...
## 3. soft_support_raw — candidate ceiling reviewer-safe
- num_examples: `500`
- k: `20`
- gold_present_rate: `0.24`
- mrr_at20: `0.12532618`
...
## 4. soft_support_raw — E2E generation reviewer-safe
- num_examples: `500`
- k: `20`
- gold_present_rate: `0.24`
- mrr_at20: `0.07467554`
