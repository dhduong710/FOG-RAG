...
- total_path_sequences_checked: 30696
- valid_mechanism_path_sequences: 77
- direct_task_edge_sequences: 2313
- blocked_explanation_sequences: 0
- unsupported_path_sequences: 28306
- queries_with_no_candidate_to_query_path: 24

### Top unsupported path patterns
- indication -> indication -> indication: 16238
- indication -> associated_with -> associated_with: 11971
- target -> target -> indication: 97
...
- query=streptococcal infection | candidate=Oxytetracycline | path=indication -> indication -> indication
- query=streptococcal infection | candidate=Oxytetracycline | path=indication -> indication -> indication
- query=streptococcal infection | candidate=Oxytetracycline | path=indication -> indication -> indication
- query=streptococcal infection | candidate=Oxytetracycline | path=indication -> indication -> indication
