...
CKPT="${CKPT:-results/week23/e2e_pharmkg/main_checkpoint/checkpoint-final}"

CONFIG_JSON="results/week24/pharmkg_decoding_sweep_valid/configs.json"
OUT_ROOT="results/week24/pharmkg_decoding_sweep_valid"
...
python - <<'PY' > results/week24/pharmkg_decoding_sweep_valid/config_lines.tsv
import json
p = "results/week24/pharmkg_decoding_sweep_valid/configs.json"
...
done < results/week24/pharmkg_decoding_sweep_valid/config_lines.tsv
