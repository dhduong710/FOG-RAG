...
CONFIG_JSON = ROOT / "results/week24/pharmkg_decoding_sweep_valid/configs.json"
PRED_ROOT = ROOT / "results/week24/pharmkg_decoding_sweep_valid/decoding_sweep_predictions"

OUT_SUMMARY = ROOT / "results/week24/pharmkg_decoding_sweep_valid/pharmkg_decoding_sweep_summary.json"
OUT_BEST = ROOT / "results/week24/pharmkg_decoding_sweep_valid/pharmkg_decoding_sweep_best_config.json"
OUT_MD = ROOT / "reports/week24/day6b_pharmkg_valid_decoding_sweep.md"
...
def main() -> None:
    ...
    lines = []
    lines.append("# Week 24 Extension Day 6B — PharmKG Valid Decoding Sweep")
    lines.append("")
    ...
    lines.append("- Raw `infer.py` metrics are ignored for paper-facing selection.")
