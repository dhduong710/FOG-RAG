...
OUT_MD = ROOT / "reports/week24/day5_model_compare_eval_and_selection.md"
...
def main() -> None:
    ...
    # Determine whether each model preserves FOG-RAG trend on test.
    trend_checks = {}
    for model_tag in MODELS:
        b = [
            r for r in summary_rows
    ...
    # Markdown report
    lines = []
    lines.append("# Week 24 Day 5  PrimeKG Model Comparison Evaluation and Selection")
    lines.append("")
