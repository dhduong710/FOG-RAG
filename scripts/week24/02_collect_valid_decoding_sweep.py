...
ROOT = Path(".").resolve()
CONFIG_JSON = ROOT / "results/week24/decoding_sweep_valid/configs.json"
PRED_ROOT = ROOT / "results/week24/decoding_sweep_valid/decoding_sweep_predictions"
OUT_SUMMARY = ROOT / "results/week24/decoding_sweep_valid/decoding_sweep_summary.json"
OUT_BEST = ROOT / "results/week24/decoding_sweep_valid/decoding_sweep_best_config.json"
OUT_MD = ROOT / "reports/week24/day2_valid_decoding_sweep.md"
...
def main() -> None:
    ...
    lines = []
    lines.append("# Week 24 Day 2 — PrimeKG Valid Decoding Sweep")
    lines.append("")
    ...
    lines.append("- Day 3 must use the frozen config from `decoding_sweep_best_config.json`.")
