...
FEATURE_PATH = Path("dataset/setting_a/25_n2_support_features/valid_support_features.json")

ROW_PATHS = {
    "backbone_raw": Path("dataset/setting_a/23_noinj_source/valid_top20_raw.json"),
    "ontology_raw": Path("dataset/setting_a/24_noinj_ontology/valid_top20_ontology_raw.json"),
    "soft_support_raw_b025": Path("dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_b025.json"),
    "soft_support_raw_b050": Path("dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_b050.json"),
    "soft_support_raw_bcap": Path("dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_bcap.json"),
}

OUT_COMPARE = Path("results/week14/soft_support_valid_compare.json")
OUT_PAIRWISE = Path("results/week14/soft_support_pairwise_order_match.json")
...
def main():
    ...
    out = {
        ...
        "notes": [
            "Week 14 is still candidate-stage only.",
