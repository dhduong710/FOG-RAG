...
SRC_MAIN = Path("dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_b050.json")
SRC_CONTRAST = Path("dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_bcap.json")
SRC_COMPARE = Path("results/week14/soft_support_valid_compare.json")
SRC_CASES = Path("results/week14/soft_support_case_summary.json")

OUT_MAIN = Path("dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_main.json")
OUT_MANIFEST = Path("dataset/setting_a/26_n2_soft_support/support_main_manifest.json")
OUT_DECISION = Path("results/week14/soft_support_main_decision.json")
...
def main():
    ...
    manifest = {
        "week": 14,
        "stage": "select_soft_support_main",
    ...
    decision = {
        ...
        "week15_policy": [
            ...
            "prepare transition toward retrieval-stage work without changing the frozen raw source"
        ]
    }
