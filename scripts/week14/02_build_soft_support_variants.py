...
CONFIG_DIR = Path("configs/week14")
OUT_DIR = Path("dataset/setting_a/26_n2_soft_support")
SUMMARY_PATH = Path("results/week14/soft_support_build_summary.json")
...
def main():
    ...
    all_summary = {
        "week": 14,
        "stage": "build_soft_support_variants",
