...
BACKBONE_PATH = Path("dataset/setting_a/23_noinj_source/valid_top20_raw.json")
B050_PATH = Path("dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_b050.json")
BCAP_PATH = Path("dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_bcap.json")

OUT_CASES = Path("results/week14/soft_support_case_samples.json")
OUT_SUMMARY = Path("results/week14/soft_support_case_summary.json")
