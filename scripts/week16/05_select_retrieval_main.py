...
OUT_MAIN_JSON = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_fuzzy_retrieval_main.json"
OUT_MAIN_MANIFEST = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/retrieval_main_manifest.json"
OUT_DECISION = ROOT / "results/week16/retrieval_main_decision.json"
OUT_REPORT = ROOT / "reports/week16/day5_main_row_decision.md"
...
def main() -> None:
    ...
    print("=" * 80)
    print("DAY 5 MAIN RETRIEVAL ROW SELECTED")
