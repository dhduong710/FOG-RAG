...
V1_PATH = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_fuzzy_retrieval_v1.json"
TIGHT_PATH = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_soft_support_fuzzy_retrieval_tight.json"
DIRECTPLUS_PATH = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_soft_support_fuzzy_retrieval_directplus.json"
COMPARE_PATH = ROOT / "results/week16/retrieval_valid_compare.json"

OUT_JSON = ROOT / "results/week16/retrieval_case_samples_main.json"
OUT_MD = ROOT / "reports/week16/day4_case_review.md"
...
def main() -> None:
    ...
    out = {
        ...
        "day4_takeaway": [
            ...
            "anchor caution should be carried to day-5 decision but should not be confused with a ranking collapse."
        ]
    }
    ...
    md_lines = [
        ...
        "",
        "## Day-4 takeaway",
        "\n".join([f"- {x}" for x in out["day4_takeaway"]]),
    ]
    OUT_MD.parent.mkdir(parents=True, exist_ok=True)
    OUT_MD.write_text("\n".join(md_lines), encoding="utf-8")

    print("=" * 80)
    print("DAY 4 CASE REVIEW BUILT")
    print("json  :", OUT_JSON)
    print("md    :", OUT_MD)
    print("=" * 80)
