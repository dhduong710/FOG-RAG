...
FUZZY_VARIANT_PATHS = {
    "soft_support_fuzzy_retrieval_v1": ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_fuzzy_retrieval_v1.json",
    "soft_support_fuzzy_retrieval_tight": ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_soft_support_fuzzy_retrieval_tight.json",
    "soft_support_fuzzy_retrieval_directplus": ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_soft_support_fuzzy_retrieval_directplus.json",
}

OUT_COMPARE = ROOT / "results/week16/retrieval_valid_compare.json"
OUT_SUMMARY = ROOT / "results/week16/retrieval_sweep_summary.json"
OUT_REPORT = ROOT / "reports/week16/day3_valid_sweep_compare.md"
...
def main() -> None:
    ...
    print("=" * 80)
    print("DAY 3 VALID SWEEP COMPARE DONE")
