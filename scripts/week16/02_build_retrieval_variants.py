...
OUT_DIR = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval"
SUMMARY_OUT = ROOT / "results/week16/retrieval_variant_build_summary.json"
REPORT_OUT = ROOT / "reports/week16/day2_build_variants.md"

CONFIG_PATHS = [
    ROOT / "configs/week16/retrieval_tight.json",
    ROOT / "configs/week16/retrieval_directplus.json",
]
...
def main() -> None:
    ...
    save_json(SUMMARY_OUT, {"week": 16, "day": 2, "variant_summaries": summaries})

    report_lines = [
        "# Week 16 - Day 2 Build Retrieval Variants",
        "",
        "## Built variants",
    ]
    for s in summaries:
