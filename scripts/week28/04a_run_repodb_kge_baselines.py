...
"""
Week 22 Day 5: Rerun repoDB structure baselines as top-20 candidate generators.
...
ROOT = Path(".")
SPLIT_DIR = ROOT / "dataset" / "setting_f_repodb" / "02_splits"
GRAPH_DIR = ROOT / "dataset" / "setting_f_repodb" / "03_graph"
BASELINE_DIR = ROOT / "dataset" / "setting_f_repodb" / "04_baseline_outputs"
...
def write_report(valid_metrics: list[dict[str, Any]], test_metrics: list[dict[str, Any]]) -> None:
    ...
    md = f"""# Week 28 Day 4 — repoDB Structure Baselines
