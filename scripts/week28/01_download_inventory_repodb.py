...
def write_report(summary: dict[str, Any]) -> None:
    ...
    lines = []
    lines.append("# Week 28 Day 1  repoDB raw inventory")
    lines.append("")
    ...
    lines.append("```")
    lines.append("")
    lines.append("If automatic RData export failed, manually download the full repoDB dataset from the repoDB web app and place it under `dataset/setting_f_repodb/00_raw_inventory/manual/`, then rerun Day 1 with `--skip-download`.")
    lines.append("")
...
def main():
    ...
    summary = {
        ...
        "next_step": "Day 2 normalize repoDB status/drug/disease fields and freeze task schema.",
    }
