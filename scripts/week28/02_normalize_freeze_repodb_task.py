...
DRKG_GRAPH_DIR = ROOT / "dataset" / "setting_e_drkg" / "03_graph"
...
def write_report(summary: dict[str, Any]) -> None:
    ...
    lines = []
    lines.append("# Week 28 Day 2  repoDB normalization and task schema freeze")
    lines.append("")
...
def main():
    ...
    task_spec = {
        ...
        "paper_claim_level": "Clinical drug-repositioning external validation using approved repoDB pairs; not a claim of prospective clinical validation.",
