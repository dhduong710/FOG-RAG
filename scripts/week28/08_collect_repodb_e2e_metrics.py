...
ROOT = Path(".")
RESULT_ROOT = ROOT / "results" / "week28" / "e2e_repodb_rgcn"
REPORT_DIR = ROOT / "reports" / "week28"

SUMMARY_PATH = ROOT / "results" / "week28" / "repodb_e2e_rgcn_summary.json"
REPORT_PATH = REPORT_DIR / "day8_repodb_e2e_rgcn_closeout.md"

ROWS = {
    "backbone_raw": "dataset/setting_f_repodb/09_e2e_soft_support_ready/rgcn_raw_display_control",
    "soft_support_sweep": "dataset/setting_f_repodb/09_e2e_soft_support_ready/rgcn_sweep_selected",
    "fuzzy_retrieval_main": "dataset/setting_f_repodb/11_e2e_fuzzy_retrieval_ready/rgcn",
}
...
def write_report(summary: dict[str, Any]) -> None:
    lines = []
    lines.append("# Week 28 Day 8 — repoDB R-GCN E2E closeout")
    lines.append("")
