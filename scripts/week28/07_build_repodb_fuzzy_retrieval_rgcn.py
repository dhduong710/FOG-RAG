...
INPUT_DIR = SETTING_DIR / "09_e2e_soft_support_ready" / "rgcn_raw_display_control"

FUZZY_DIR = SETTING_DIR / "10_fuzzy_retrieval" / "rgcn"
E2E_DIR = SETTING_DIR / "11_e2e_fuzzy_retrieval_ready" / "rgcn"
...
def write_report(summary: dict[str, Any]):
    ...
    lines = []
    lines.append("# Week 28 Day 7  repoDB fuzzy retrieval on R-GCN raw-display-control")
    lines.append("")
