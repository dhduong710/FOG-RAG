...
SOFT_DIR = SETTING_DIR / "08_soft_support" / "rgcn_sweep_selected"
E2E_DIR = SETTING_DIR / "09_e2e_soft_support_ready" / "rgcn_sweep_selected"
...
def write_report(summary):
    ...
    lines = []
    lines.append("# Week 28 Day 6  repoDB R-GCN soft support")
    lines.append("")
