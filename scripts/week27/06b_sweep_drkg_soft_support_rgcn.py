...
SOURCE_DIR = SETTING_DIR / "05_backbone_raw_source" / "rgcn"
READY_DIR = SETTING_DIR / "06_fograg_ready" / "rgcn"
SUPPORT_DIR = SETTING_DIR / "07_support_features" / "rgcn"

OUT_SOFT_ROOT = SETTING_DIR / "08_soft_support" / "rgcn_sweep_selected"
OUT_E2E_ROOT = SETTING_DIR / "09_e2e_soft_support_ready" / "rgcn_sweep_selected"
...
def write_report(summary: dict[str, Any]):
    ...
    lines = []
    lines.append("# Week 27 Day 6b — DRKG R-GCN soft-support sweep")
    lines.append("")
