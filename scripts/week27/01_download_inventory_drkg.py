...
def write_markdown_report(path: Path, summary: dict[str, Any]) -> None:
    ...
    lines = []
    lines.append("# Week 27 Day 1  DRKG raw inventory")
    lines.append("")
    ...
    lines.append("")
    lines.append("Do not freeze the task yet. Day 2 should choose one target relation based on:")
    lines.append("")
...
def main():
    ...
    raw_dir = mkdir(setting_dir / "00_raw_inventory")
    task_dir = mkdir(setting_dir / "01_task_spec")
    result_dir = mkdir(repo / "results" / "week27")
    report_dir = mkdir(repo / "reports" / "week27")
    ...
    summary = {
        ...
        "inventory": manifest,
        "scan": scan,
        "next_step": "Day 2 should select target relation and freeze task/schema/protocol.",
    }
