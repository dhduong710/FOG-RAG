...
SOFT_E2E_DIR = SETTING_DIR / "09_e2e_soft_support_ready" / "rgcn_sweep_selected"

FUZZY_DIR = SETTING_DIR / "10_fuzzy_retrieval" / "rgcn"
E2E_FUZZY_DIR = SETTING_DIR / "11_e2e_fuzzy_retrieval_ready" / "rgcn"
...
def write_report(summary: dict[str, Any]):
    ...
    lines = []
    lines.append("# Week 27 Day 7  DRKG fuzzy retrieval for R-GCN sweep-selected")
    lines.append("")
