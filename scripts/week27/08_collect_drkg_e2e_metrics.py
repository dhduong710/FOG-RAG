...
ROOT = Path(".")
RESULT_ROOT = ROOT / "results" / "week27" / "e2e_drkg_rgcn"
REPORT_DIR = ROOT / "reports" / "week27"

SUMMARY_PATH = ROOT / "results" / "week27" / "drkg_e2e_rgcn_summary.json"
REPORT_PATH = REPORT_DIR / "day8_drkg_e2e_rgcn_closeout.md"

ROWS = {
    "backbone_raw": "dataset/setting_e_drkg/06_fograg_ready/rgcn",
    "soft_support_sweep": "dataset/setting_e_drkg/09_e2e_soft_support_ready/rgcn_sweep_selected",
    "fuzzy_retrieval_main": "dataset/setting_e_drkg/11_e2e_fuzzy_retrieval_ready/rgcn",
}
...
def write_report(summary: dict[str, Any]) -> None:
    lines = []
    lines.append("# Week 27 Day 8 — DRKG R-GCN E2E closeout")
    lines.append("")
