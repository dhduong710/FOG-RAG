...
IN_FEATURES = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_path_features.json"
OUT_JSON = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_fuzzy_retrieval_v1.json"
OUT_MANIFEST = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/path_score_manifest.json"
OUT_REPORT = ROOT / "reports/week15/day3_retrieval_build.md"
...
def main() -> None:
    ...
    manifest = {
        ...
        "notes": [
            ...
            "ontology_consistency_flag is disabled in v1 because schema_known_count was zero on day 2.",
            "Selection policy = coverage pass + global fill.",
            "Candidate order remains frozen from soft_support_raw."
        ],
        "weights": {
    ...
    print("=" * 80)
    print("DAY 3 RETRIEVAL BUILD DONE")
    print("json    :", OUT_JSON)
