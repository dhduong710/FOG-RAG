...
COMPARE_PATH = ROOT / "results/week15/retrieval_valid_compare_v1.json"

OUT_JSON = ROOT / "results/week15/retrieval_case_samples_v1.json"
OUT_REPORT = ROOT / "reports/week15/day5_case_review.md"
...
def main() -> None:
    ...
    # Cắt số lượng để review thủ công
    out = {
        "week": 15,
        "day": 5,
        "summary_from_day4": {
        ...
        "day5_takeaway": [
            "There were no ranking improvements over soft_support_raw on day 4.",
            "Therefore, day 5 focuses on evidence cleanliness, preservation of prior gains, unchanged-bad cases, and raw bottleneck failures.",
        ],
    }
    ...
    print("=" * 80)
    print("DAY 5 CASE REVIEW BUILT")
    print("json  :", OUT_JSON)
    print("report:", OUT_REPORT)
    print("=" * 80)
    print(json.dumps(out["bucket_counts"], ensure_ascii=False, indent=2))
    print("=" * 80)
    print(json.dumps(out["summary_from_day4"], ensure_ascii=False, indent=2))
