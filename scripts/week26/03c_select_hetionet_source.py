...
def main() -> None:
    ...
    source = {
        ...
        "reason": (
            "R-GCN is selected as the main DrKGC/FOG-RAG source for consistency "
            "with PrimeKG, PharmKG, and the DrKGC-style graph-adapter pipeline. "
            "All six structure baselines should still be reported in the paper table. "
    ...
    md_lines = []
    md_lines.append("# Week 26 Day 3 — Hetionet source selection")
    md_lines.append("")
    ...
    md_lines.append("")
    md_lines.append(
        "R-GCN is selected as the primary FOG-RAG/DrKGC-ready source for consistency "
