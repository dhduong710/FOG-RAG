...
SOFT_E2E_DIR = SETTING_DIR / "09_e2e_soft_support_ready"
FUZZY_DIR = SETTING_DIR / "10_fuzzy_retrieval"
E2E_FUZZY_DIR = SETTING_DIR / "11_e2e_fuzzy_retrieval_ready"
...
def write_report(path: Path, summary: dict[str, Any]):
    lines = []
    lines.append("# Week 26 Day 6  Hetionet confidence-aware fuzzy retrieval")
    lines.append("")
