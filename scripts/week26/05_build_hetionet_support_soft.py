...
BACKBONE_READY_DIR = SETTING_DIR / "06_fograg_ready"

SUPPORT_DIR = SETTING_DIR / "07_support_features"
SOFT_DIR = SETTING_DIR / "08_soft_support"
E2E_SOFT_DIR = SETTING_DIR / "09_e2e_soft_support_ready"
...
def write_report(path: Path, summary: dict[str, Any]):
    lines = []
    lines.append("# Week 26 Day 5  Hetionet support features and soft support")
    lines.append("")
