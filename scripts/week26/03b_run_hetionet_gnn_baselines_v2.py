...
def write_report(table):
    ...
    md = []
    md.append("# Week 26 Day 3  Hetionet Structure Baselines")
    md.append("")
    md.append("## Protocol")
    md.append("")
    md.append("- Dataset: Hetionet v1.0")
    md.append("- Task: `(?, CtD, disease)`")
    md.append("- Relation normalized: `compound_treats_disease`")
    ...
    md.append("## Notes")
    md.append("")
    md.append("- GNN v2 uses target-balanced sampling for sparse CtD training.")
