...
"""
Week 22 Day 5b: Rerun Hetionet GNN baselines.
...
5. Updates:
   - results/week22/hetionet_baseline_reviewer_safe_valid.json
   - results/week22/hetionet_baseline_reviewer_safe_test.json
   - results/week22/hetionet_baseline_main_table.json
   - reports/week22/day5_baseline_rerun_hetionet.md
"""
...
SPLIT_DIR = ROOT / "dataset" / "setting_d_hetionet" / "02_splits"
GRAPH_DIR = ROOT / "dataset" / "setting_d_hetionet" / "03_graph"
BASELINE_DIR = ROOT / "dataset" / "setting_d_hetionet" / "04_baseline_outputs"

RESULT_DIR = ROOT / "results" / "week26"
REPORT_DIR = ROOT / "reports" / "week26"

VALID_METRICS_PATH = RESULT_DIR / "hetionet_baseline_reviewer_safe_valid.json"
TEST_METRICS_PATH = RESULT_DIR / "hetionet_baseline_reviewer_safe_test.json"
MAIN_TABLE_PATH = RESULT_DIR / "hetionet_baseline_main_table.json"
REPORT_PATH = REPORT_DIR / "day3_hetionet_structure_baselines.md"
...
def write_main_table(valid_metrics: list[dict[str, Any]], test_metrics: list[dict[str, Any]]) -> dict[str, Any]:
    table = {
        "dataset": "Hetionet v1.0 compound_treats_disease benchmark",
        "protocol": {
            "task": "(?, CtD, disease)",
            "candidate_universe": "Compound",
            "top_k": TOP_K,
...
def write_report(main_table: dict[str, Any]) -> None:
    ...
    md = f"""# Week 26 Day 3 — Hetionet Structure Baselines
