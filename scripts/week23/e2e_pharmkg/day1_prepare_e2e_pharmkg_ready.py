...
READY06 = BASE / "06_fograg_ready"
OUT_ROOT = BASE / "13_e2e_infer_ready"

SOFT_DIR = BASE / "10_soft_support"
FUZZY_DIR = BASE / "11_fuzzy_retrieval"
RGCN_STATE = BASE / "04_baseline_outputs" / "rgcn" / "model_state.pt"
...
def build_one_row(row_name, emb_shape):
    ...
    split_summaries["train"] = {
        ...
        "note": "Copied from 06_fograg_ready/train.json for supervised E2E training compatibility.",
    }
...
def write_report(root_manifest):
    ...
    lines.append("")
    lines.append("```bash")
    lines.append("--kge_embedding_path dataset/setting_c_pharmkg/13_e2e_infer_ready/entity_embeddings_rgcn.pt \\")
