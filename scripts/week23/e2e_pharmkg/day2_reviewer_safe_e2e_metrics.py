...
ROOT = Path("dataset/setting_c_pharmkg/13_e2e_infer_ready")
PRED_ROOT = Path("results/week23/e2e_pharmkg/main_checkpoint")
OUT_ROOT = Path("results/week23/e2e_pharmkg/reviewer_safe")
