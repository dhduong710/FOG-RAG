...
- dataset/setting_c_pharmkg/07_transfer_eval_ready/backbone_raw_{valid,test}.json
- dataset/setting_c_pharmkg/03_graph/{entity2id,relation2id,type_map,train_enriched.tsv}
...
- reports/week23/day2_support_features_and_hard_control.md
"""
...
TRANSFER_EVAL_DIR = ROOT / "dataset" / "setting_c_pharmkg" / "07_transfer_eval_ready"
SUPPORT_DIR = ROOT / "dataset" / "setting_c_pharmkg" / "08_support_features"
HARD_DIR = ROOT / "dataset" / "setting_c_pharmkg" / "09_hard_support_raw"
    ...
    for row in support_rows:
        ...
        eval_row = {
            ...
            "stage_specific": {
                ...
                "paper_label": "hard graph-support control, not ontology filtering",
...
def main() -> None:
    ...
    valid_ready = read_json(FOGRAG_READY_DIR / "valid.json")
    test_ready = read_json(FOGRAG_READY_DIR / "test.json")
