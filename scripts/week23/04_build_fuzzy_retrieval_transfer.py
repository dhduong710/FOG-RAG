...
Input:
- dataset/setting_c_pharmkg/06_fograg_ready/{valid,test}.json
- dataset/setting_c_pharmkg/10_soft_support/{valid,test}_top20_soft_support_main.json
- dataset/setting_c_pharmkg/08_support_features/{valid,test}_support_features.json
- results/week23/soft_support_raw_eval_{valid,test}.json

Output:
- dataset/setting_c_pharmkg/11_fuzzy_retrieval/{valid,test}_path_features.json
- dataset/setting_c_pharmkg/11_fuzzy_retrieval/{valid,test}_fuzzy_retrieval_main.json
...
- results/week23/fuzzy_retrieval_eval_{valid,test}.json
- reports/week23/day4_fuzzy_retrieval_transfer.md
"""
...
SOFT_DIR = ROOT / "dataset" / "setting_c_pharmkg" / "10_soft_support"
SUPPORT_DIR = ROOT / "dataset" / "setting_c_pharmkg" / "08_support_features"
RETRIEVAL_DIR = ROOT / "dataset" / "setting_c_pharmkg" / "11_fuzzy_retrieval"
...
def build_ready_by_index(split: str) -> dict[int, dict[str, Any]]:
    rows = read_json(FOGRAG_READY_DIR / f"{split}.json")
