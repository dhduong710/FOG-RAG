...
Output:
    ...
    dataset/setting_c_pharmkg/02_splits/train_target.tsv
    dataset/setting_c_pharmkg/02_splits/valid_target.tsv
    dataset/setting_c_pharmkg/02_splits/test_target.tsv
    dataset/setting_c_pharmkg/02_splits/candidate_universe.json
    dataset/setting_c_pharmkg/02_splits/query_universe.json

    dataset/setting_c_pharmkg/03_graph/entity2id.json
    dataset/setting_c_pharmkg/03_graph/id2entity.json
    dataset/setting_c_pharmkg/03_graph/relation2id.json
    dataset/setting_c_pharmkg/03_graph/id2relation.json
    dataset/setting_c_pharmkg/03_graph/type_map.json
    dataset/setting_c_pharmkg/03_graph/train_enriched.tsv
    dataset/setting_c_pharmkg/03_graph/train_enriched_relation_counts.json
...
def main() -> None:
    ...
    if not TASK_SPEC_PATH.exists():
        raise FileNotFoundError(
            ...
            "Run scripts/week22/03_select_task_schema.py first."
        )
