...
INPUTS = {
    "backbone_raw": ROOT / "dataset/setting_a/23_noinj_source/valid_top20_raw.json",
    "ontology_raw": ROOT / "dataset/setting_a/24_noinj_ontology/valid_top20_ontology_raw.json",
    "soft_support_raw": ROOT / "dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_main.json",
    "retrieval_main": ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_fuzzy_retrieval_main.json",
    "valid_b": ROOT / "dataset/setting_b/04_contra_checked/valid_b_annotations_contra_checked.json",
}

OUT_DIR = ROOT / "dataset/setting_b/07_n2_eval_valid"
OUT_REPORT = ROOT / "reports/week18/day2_valid_eval_ready.md"
...
def main():
    ...
    lines = []
    lines.append("# Week 18 Day 2 — Valid Eval-Ready Package\n")
    lines.append("## Goal")
    lines.append("- Standardize 4 valid rows into one eval-ready schema.")
    lines.append("- Prepare clean inputs for day-3 valid main table building.")
    lines.append("")
    ...
    for name, summary in all_summaries.items():
        ...
        lines.append("")
    lines.append("## Notes")
    lines.append("- No table or ablation decision is made on day 2.")
    lines.append("- Day 2 only standardizes row schemas and joins Setting-B annotations.")
    lines.append("")
