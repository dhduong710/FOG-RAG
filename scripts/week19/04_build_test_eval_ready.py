...
# ---------- input test sources ----------
BACKBONE_TEST = ROOT / "dataset/setting_a/23_noinj_source/test_top20_raw.json"
ONTOLOGY_TEST = ROOT / "dataset/setting_a/24_noinj_ontology/test_top20_ontology_raw.json"
SOFT_TEST = ROOT / "dataset/setting_a/26_n2_soft_support/test_top20_soft_support_main.json"
RETR_TEST = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/test_fuzzy_retrieval_main.json"
TEST_B = ROOT / "dataset/setting_b/04_contra_checked/test_b_annotations_contra_checked.json"
...
# ---------- outputs ----------
OUT_DIR = ROOT / "dataset/setting_b/08_n2_eval_test"
OUT_PATHS = {
...
SUMMARY_PATH = ROOT / "results/week19/test_eval_ready_summary.json"
REPORT_PATH = ROOT / "reports/week19/day4_test_eval_ready.md"
...
def main():
    ...
    md = []
    md.append("# Day 4 — Build test eval-ready package")
    md.append("")
    ...
    md.append("")
    md.append("## 5. Day-4 conclusion")
    md.append(
        "Built test eval-ready package for all four scientific rows under the frozen reviewer-safe "
        "policy, with unified schema, gold_rank sentinel=21 for out-of-top20, and row-level metrics "
        "ready for locked-test aggregation on Day 5."
    )
