...
EVID_PATH = ROOT / "dataset/setting_a/24b_noinj_evidence/test_aligned_evidence.json"
SUPPORT_PATH = ROOT / "dataset/setting_a/26_n2_soft_support/test_top20_soft_support_main.json"
...
MANIFEST_PATH = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/retrieval_main_manifest.json"

CONFIG_TIGHT = ROOT / "configs/week16/retrieval_tight.json"
CONFIG_DIRECTPLUS = ROOT / "configs/week16/retrieval_directplus.json"

ID2REL_CANDIDATES = [
    ROOT / "dataset/setting_a/04_drkgc_json/id2relation.pkl",
    ROOT / "dataset/setting_a/08_backbone_ready/id2relation.pkl",
]

OUT_FEATURES = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/test_path_features.json"
OUT_MAIN = ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/test_fuzzy_retrieval_main.json"
OUT_SUMMARY = ROOT / "results/week19/retrieval_test_build_summary.json"
OUT_REPORT = ROOT / "reports/week19/day3_build_retrieval_test.md"
...
def main() -> None:
    ...
    summary = {
        ...
        "schema_check": {
            ...
            "selected_source_variant_frozen": True,
    ...
    for k, v in summary["policy_checks"].items():
        md.append(f"- {k}: `{v}`")
    md.append("")
    md.append("## 5. Day-3 conclusion")
    md.append(
        "Built `test_fuzzy_retrieval_main.json` by reusing the frozen selected retrieval source "
