...
MAIN_TABLE_PATH = ROOT / "results/week19/test_main_table.json"
ABLATION_PATH = ROOT / "results/week19/test_ablation.json"
REPORT_PATH = ROOT / "reports/week19/day5_locked_test_table.md"
...
def main():
    ...
    if retrieval_preserves:
        ...
        decision_reason = (
            ...
            "while keeping the cleaner graph/evidence package."
        )
    ...
    ablation = {
        ...
        "appendix_note": {
            "encoder_probe_status": "deferred_appendix_only",
            "encoder_probe_not_in_main_table": True,
        },
    }
    ...
    md = []
    md.append("# Day 5 — Official locked test main table")
    md.append("")
    ...
    md.append("")
    md.append("## 6. Day-5 conclusion")
    md.append(
        "Built the official locked reviewer-safe test main table and ablation export. "
        "Encoder remains appendix-only; the four scientific rows are now aggregated and ready "
        "for test-side case review on Day 6."
    )
