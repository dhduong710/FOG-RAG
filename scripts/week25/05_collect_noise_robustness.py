...
"""
Week 25 Day 5: Collect small-noise robustness metrics.
...
VARIANT_ROOT = ROOT / "dataset" / "setting_a" / "33_week25_noise_robustness"
...
def write_report(result: Dict[str, Any], path: Path) -> None:
    lines = []
    lines.append("# Week 25 Day 5  Small-Noise Robustness\n")
