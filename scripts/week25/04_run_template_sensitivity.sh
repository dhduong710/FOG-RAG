...
# Week 25 Day 4: Question-template sensitivity E2E inference.
...
DST_CKPT="results/week25/template_sensitivity/e2e_checkpoint"

KGE_PATH="dataset/setting_a/08_backbone_ready/entity_embeddings_rgcn.pt"
OUT_DIR="results/week25/template_sensitivity"
...
for variant in "${VARIANTS[@]}"; do
  DATASET_PATH="dataset/setting_a/32_week25_template_sensitivity/${variant}"
  ...
  for split in "${SPLITS[@]}"; do
    suffix="week25_template_${variant}"
