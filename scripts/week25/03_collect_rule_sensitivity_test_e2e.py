...
"""
Week 25 Day 3: Collect rule sensitivity locked-test + E2E metrics.

Inputs:
- dataset/setting_a/31_week25_rule_sensitivity/{variant}/{valid,test}.json
- results/week25/rule_sensitivity/prediction_{split}_week25_rule_{variant}.json

Outputs:
- results/week25/rule_sensitivity/rule_sensitivity_test.json
- results/week25/rule_sensitivity/rule_sensitivity_e2e_summary.json
- reports/week25/day3_rule_sensitivity_test_e2e.md
"""
...
VARIANT_ROOT = ROOT / "dataset" / "setting_a" / "31_week25_rule_sensitivity"
...
def write_report(result: Dict[str, Any], path: Path) -> None:
    lines = []
    lines.append("# Week 25 Day 3  Rule Sensitivity Locked Test + E2E\n")
    ...
    lines.append(
        ...
        "FOG-RAG is not overly dependent on a single hard-coded rule package."
    )
    lines.append(
...
def main() -> None:
    ...
    for split in SPLITS:
        for variant in VARIANTS:
            ...
            pred_path = RESULTS_DIR / f"prediction_{split}_week25_rule_{variant}.json"
