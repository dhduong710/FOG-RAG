...
"""
Week 25 Day 4: Build question-template sensitivity variants.
...
OUT_ROOT = ROOT / "dataset" / "setting_a" / "32_week25_template_sensitivity"
RESULTS_DIR = ROOT / "results" / "week25" / "template_sensitivity"
...
def build_variant_rows(rows: List[Dict[str, Any]], split: str, variant: str, template: str) -> List[Dict[str, Any]]:
    ...
    for row in rows:
        ...
        r["week25_template_variant"] = variant
        r["week25_template_string"] = template
        r["week25_split"] = split
        r["infer_row_name"] = f"week25_template_{variant}"
...
def main() -> None:
    ...
    manifest = {
        ...
        "notes": [
            ...
            "T0_canonical remains the main paper prompt.",
