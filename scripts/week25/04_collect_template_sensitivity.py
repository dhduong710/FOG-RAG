...
"""
Week 25 Day 4: Collect question-template sensitivity metrics.
"""
...
VARIANT_ROOT = ROOT / "dataset" / "setting_a" / "32_week25_template_sensitivity"
...
def write_report(result: Dict[str, Any], path: Path) -> None:
    ...
    lines.append("# Week 25 Day 4  Question-Template Sensitivity\n")
...
def main() -> None:
    ...
    for split in SPLITS:
        for variant in VARIANTS:
            ...
            pred_path = RESULTS_DIR / f"prediction_{split}_week25_template_{variant}.json"
