...
BACKBONE_RAW_METRICS = ROOT / "results/week20/ranking_metrics_test_backbone_raw_e2e.json"
SOFT_RAW_METRICS = ROOT / "results/week20/ranking_metrics_test_soft_support_raw_e2e.json"
...
def main() -> None:
    ...
    summary = {
        ...
        "metric_policy": {
            ...
            "important_note": (
                "Do not use raw infer.py mrr for paper tables unless infer.py is patched. "
