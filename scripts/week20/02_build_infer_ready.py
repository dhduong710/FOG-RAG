...
# ---------- frozen week20 protocol ----------
W20_PROTOCOL = ROOT / "results/week20/e2e_protocol_freeze.json"

# ---------- shared train placeholder ----------
TRAIN_PLACEHOLDER = ROOT / "dataset/setting_a/08_backbone_ready/train.json"

# ---------- canonical aligned evidence base ----------
ALIGNED = {
    "valid": ROOT / "dataset/setting_a/24b_noinj_evidence/valid_aligned_evidence.json",
    "test": ROOT / "dataset/setting_a/24b_noinj_evidence/test_aligned_evidence.json",
}
...
SOFT = {
    "valid": ROOT / "dataset/setting_a/26_n2_soft_support/valid_top20_soft_support_main.json",
    "test": ROOT / "dataset/setting_a/26_n2_soft_support/test_top20_soft_support_main.json",
}
RETR = {
    "valid": ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/valid_fuzzy_retrieval_main.json",
    "test": ROOT / "dataset/setting_a/27_n2_fuzzy_retrieval/test_fuzzy_retrieval_main.json",
}

OUT_ROOT = ROOT / "dataset/setting_a/29_n2_e2e_infer_ready"
ROW_DIRS = {
...
SUMMARY_PATH = ROOT / "results/week20/infer_ready_build_summary.json"
REPORT_PATH = ROOT / "reports/week20/day2_build_infer_ready.md"
...
def main():
    protocol = load_json(W20_PROTOCOL)
    assert protocol["status"] == "READY_FOR_E2E_CONFIRMATION", "Week20 protocol is not ready"

    assert TRAIN_PLACEHOLDER.exists(), f"Missing train placeholder: {TRAIN_PLACEHOLDER}"
    ...
    md = []
    md.append("# Day 2 — Build infer-ready packages")
    md.append("")
