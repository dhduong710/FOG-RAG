...
IN_PATH = Path("dataset/setting_a/25_n2_support_features/valid_support_features.json")
OUT_JSON = Path("dataset/setting_a/25_n2_support_features/valid_support_probe.json")
OUT_SUMMARY = Path("results/week13/support_formula_probe.json")
...
def main():
    ...
    final_summary = {
        "week": 13,
        "stage": "support_score_probe",
        "input": str(IN_PATH),
        "output": str(OUT_JSON),
        "formula_summaries": summary,
        "best_formula_by_mrr_like": best_formula,
        "notes": [
            "This is only a probing stage in week 13.",
