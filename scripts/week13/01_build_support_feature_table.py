...
RAW_PATH = Path("dataset/setting_a/23_noinj_source/valid_top20_raw.json")
TYPE_FILTERED_PATH = Path("dataset/setting_a/24_noinj_ontology/valid_top20_type_filtered_raw.json")
ONTOLOGY_RAW_PATH = Path("dataset/setting_a/24_noinj_ontology/valid_top20_ontology_raw.json")
ALIGNED_EVIDENCE_PATH = Path("dataset/setting_a/24b_noinj_evidence/valid_aligned_evidence.json")

TYPE_MAP_PATH = Path("dataset/setting_b/01_annotations/type_map.tsv")
SCHEMA_RULES_PATH = Path("dataset/setting_b/01_annotations/schema_rules.json")
VALID_B_PATH = Path("dataset/setting_b/04_contra_checked/valid_b_annotations_contra_checked.json")

OUT_DIR = Path("dataset/setting_a/25_n2_support_features")
