...
## Inputs
- input_dir: `dataset/setting_a/04_drkgc_json`
...
## Outputs
- `dataset/setting_a/08_backbone_ready/train.json`
- `dataset/setting_a/08_backbone_ready/valid.json`
- `dataset/setting_a/08_backbone_ready/test.json`
- `dataset/setting_a/08_backbone_ready/entity2id.pkl`
- `dataset/setting_a/08_backbone_ready/id2entity.pkl`
- `dataset/setting_a/08_backbone_ready/relation2id.pkl`
- `dataset/setting_a/08_backbone_ready/id2relation.pkl`
- `dataset/setting_a/08_backbone_ready/backbone_ready_manifest.json`
